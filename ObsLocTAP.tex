...
ObsLocTAP reuses various model elements (including geometrical entities) of ObsCore and, 
...
serialised according to section 6 of TAP 1.0 (\citealt{2011ivoa.spec.1028T}). In
...
described into the TAP Registration Extension (TAPRegExt; \citealt{std:TAPREGEXT}) definition for ObsLocTAP services.
\par
